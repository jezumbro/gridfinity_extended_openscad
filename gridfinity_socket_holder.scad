...
part = 1; //[1: "METRIC", 2: "IMPERIAL", 3: "Imperial < 1/2\"", 4: "Imperial >= 1/2\"", 5: "Metric >=7mm", 6: "Metric <7mm"]

if (part == 1) {
  socket_holder(4, [12,12,12,13,14,16,16,17,21], "METRIC");
}
else if (part == 2) {
